...
- Name: api\auth.api.spec.ts >> API – Auth Endpoints (/api/auth) >> POST /api/auth/login >> [POSITIVE] Response includes user object with role
- Location: tests\api\auth.api.spec.ts:93:9
