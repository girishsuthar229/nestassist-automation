...
- Name: api\auth.api.spec.ts >> API – Auth Endpoints (/api/auth) >> POST /api/auth/forgot-password >> [NEGATIVE] Invalid email format → 400 validation error
- Location: tests\api\auth.api.spec.ts:133:9
