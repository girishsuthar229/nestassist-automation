...
- Name: api\auth.api.spec.ts >> API – Auth Endpoints (/api/auth) >> POST /api/auth/login >> [NEGATIVE] Non-existent email → 404 Unauthorized
- Location: tests\api\auth.api.spec.ts:56:9
