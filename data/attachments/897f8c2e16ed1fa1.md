...
- Name: forgotPassword.spec.ts >> Forgot Password – All Scenarios >> DDT – Forgot Password Scenarios >> [NEGATIVE] Unregistered email – should show not found error
- Location: tests\forgotPassword.spec.ts:45:11
