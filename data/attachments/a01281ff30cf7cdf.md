...
- Name: api\auth.api.spec.ts >> API – Auth Endpoints (/api/auth) >> POST /api/auth/login >> [NEGATIVE] Wrong password → 401 Unauthorized
- Location: tests\api\auth.api.spec.ts:41:9
