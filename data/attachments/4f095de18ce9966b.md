...
- Name: api\auth.api.spec.ts >> API – Auth Endpoints (/api/auth) >> POST /api/auth/login >> [NEGATIVE] Missing password field → 400 Bad Request
- Location: tests\api\auth.api.spec.ts:82:9
