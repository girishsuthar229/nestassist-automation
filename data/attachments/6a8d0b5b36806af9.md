...
- Name: login.spec.ts >> Login – Failed Login Scenarios >> Invalid email format backend validation – shows validation error details
- Location: tests\login.spec.ts:135:7
