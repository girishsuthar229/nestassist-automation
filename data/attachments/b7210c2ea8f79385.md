...
- Name: api\profile.api.spec.ts >> API – User Profile Endpoint (/api/user-profile) >> GET /api/user-profile/profile >> [NEGATIVE] Without token → 401 Unauthorized
- Location: tests\api\profile.api.spec.ts:51:9
