...
- Name: api\auth.api.spec.ts >> API – Auth Endpoints (/api/auth) >> POST /api/auth/forgot-password >> [NEGATIVE] Unregistered email → non-200 or error message
- Location: tests\api\auth.api.spec.ts:121:9
